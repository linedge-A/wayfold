...
export default function FocusModeSplash({ onRestoreMap, onAskCopilot }: FocusModeSplashProps) {
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 relative overflow-hidden select-none">
      ...
      <div className="text-center max-w-sm p-8 bg-white/80 border border-border-subtle rounded-2xl shadow-lg relative z-10">
        ...
        <div className="flex gap-4 justify-center">
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 border border-border-subtle hover:bg-surface-container-low text-xs font-semibold rounded-lg transition-colors cursor-pointer text-on-surface"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-4 py-2 bg-primary text-white text-xs font-semibold rounded-lg hover:opacity-95 transition-opacity cursor-pointer shadow-sm"
          >
